...
static IniFile::Section* GetSectionPointer(JNIEnv* env, jobject obj)
{
  return reinterpret_cast<IniFile::Section*>(
      env->GetLongField(obj, IDCache::sIniFileSaf.SectionPointer));
}

static IniFile* GetIniFilePointer(JNIEnv* env, jobject obj)
{
  return reinterpret_cast<IniFile*>(env->GetLongField(obj, IDCache::sIniFileSaf.Pointer));
}
...
static jobject SectionToJava(JNIEnv* env, jobject ini_file, IniFile::Section* section)
{
  ...
  return env->NewObject(IDCache::sIniFileSaf.SectionClazz, IDCache::sIniFileSaf.SectionConstructor,
...
JNIEXPORT jboolean JNICALL Java_org_dolphinemu_dolphinemu_utils_IniFileSaf_load(
...
JNIEXPORT jboolean JNICALL Java_org_dolphinemu_dolphinemu_utils_IniFileSaf_save(JNIEnv* env,
                                                                             jobject obj,
                                                                             jstring path)
{
...
JNIEXPORT jboolean JNICALL Java_org_dolphinemu_dolphinemu_utils_IniFileSaf_deleteKey(
...
JNIEXPORT jstring JNICALL Java_org_dolphinemu_dolphinemu_utils_IniFileSaf_getString(
...
JNIEXPORT jboolean JNICALL Java_org_dolphinemu_dolphinemu_utils_IniFileSaf_getBoolean(
...
JNIEXPORT jint JNICALL Java_org_dolphinemu_dolphinemu_utils_IniFileSaf_getInt(JNIEnv* env, jobject obj,
...
JNIEXPORT void JNICALL Java_org_dolphinemu_dolphinemu_utils_IniFileSaf_setString(
...
JNIEXPORT void JNICALL Java_org_dolphinemu_dolphinemu_utils_IniFileSaf_setBoolean(
...
JNIEXPORT void JNICALL Java_org_dolphinemu_dolphinemu_utils_IniFileSaf_setInt(JNIEnv* env, jobject obj,
                                                                           jstring section_name,
                                                                           jstring key,
                                                                           jint new_value)
{
...
JNIEXPORT void JNICALL Java_org_dolphinemu_dolphinemu_utils_IniFileSaf_finalize(JNIEnv* env,
                                                                             jobject obj)
{
  delete GetIniFilePointer(env, obj);
}

JNIEXPORT jlong JNICALL Java_org_dolphinemu_dolphinemu_utils_IniFileSaf_newIniFile(JNIEnv* env,
                                                                                jobject obj)
{
